...
def eight(input):
	...
	if input < 1 or input > 10:
		print("Input another number between 1 and 10")
	else:
		if input == 0:
			return 1
		return input * math.factorial(input - 1)
...
def ten(string, int, char):
	...
	if length_of_string < int:
		return False
	else:
		if char.lower() in string.lower()[int - 1]:
			return True
		else:
			return False
